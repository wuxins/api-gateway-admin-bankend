package com.cooljs.modules.task.controller.admin;
...
public class AdminTaskInfoController extends BaseController<TaskInfoService, TaskInfoEntity> {
    ...
    protected void init(HttpServletRequest request, JSONObject requestParams) {
        setPageOption(createOp().fieldEq("status", "type"));
    }
    ...
    public R log(@RequestAttribute JSONObject requestParams) {
        ...
        return R.ok(pageResult((Page<TaskInfoEntity>) service.log(new Page<>(page, size), requestParams.getLong("id"), requestParams.getInt("status"))));
    }
}
